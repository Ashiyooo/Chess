...
/**
 * PieceTest is a class that checks if the different Pieces work properly
 */
class PieceTest {

    /**
     * Checks if the queen on the middle of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the queen on a corner of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the king on the middle of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the king on a corner of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the rook on the middle of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the rook on a corner of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the bishop on the middle of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the bishop on a corner of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the knight on the middle of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the knight on a corner of the board can do these random legal moves
     */
    @Test
    ...
    /**
     * Checks if the pawn promotion works properly
     */
    @Test
    ...
    /**
     * Checks if the enPassantPawn can be captured and the new board state is correct
     */
    @Test
