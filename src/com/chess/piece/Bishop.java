...
public class Bishop extends Piece {
     ...
     * constants is brought to a while loop that keeps on adding the constant so that it can keep moving diagonally until
     * it eventually is stopped by the borders of the chess board or another piece
    ...
    /**
     * movePiece() creates a new bishop for the new state of the board
    ...
    /**
     * isColA() is a method that checks if the Bishop or its movement is at the column A
     * so that we can create special restrictions according to chess rules
     * @param currentPosition is the current tile coordinate of the bishop
    ...
    /**
     * isColH() is a method that checks if the Bishop or its movement is at the column H
     * so that we can create special restrictions according to chess rules
     * @param currentPosition is the current tile coordinate of the bishop
     * @param offset is the current constant that it is in the POSSIBLE_MOVE_TILE
     ...
     * @return the toString() of the PieceType which is the bishop in this case
     */
    @Override
