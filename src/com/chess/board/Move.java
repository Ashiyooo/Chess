...
public abstract class Move {
    ...
    /**Move Factory is a class that uses the
     * Static Factory design pattern because there are cases
     * that we will make a move not knowing the piece we are moving
     * The method createMove() can be found here
     */
    public static class MoveFactory{
        ...
        /**
         * createMove() is a method that takes in 3 parameters to move an unknown piece on the board.
         * If the move cannot be made meaning it is illegal and not in the legalMoves of the player,
         * it will return a NullMove object
         * @param board is the current board where the move will be made. This is a board object
         * @param currentPosition is the tile where we will have the initial position. This is an integer value
         * @param movePosition is the tile where we will move to. This is also an integer value
         * @return either the move if it can be done or a NullMove
         */
