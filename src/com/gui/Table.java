...
/**
 * Table is a class which extends from Observable so that we can apply the Observer design pattern for our code
 */
public class Table extends Observable{
    ...
    /**
     * Table() is a singleton because we only want 1 instance of this table at a time
     */
    private Table(){
    ...
    */
    private class TilePanel extends JPanel{
        ...
        TilePanel(final BoardPanel boardPanel, final int tileID){
            ...
            addMouseListener(new MouseListener() {
                ...
                //they do nothing but still needed to be stated for the mouselistener
                @Override
    ...
    /**
     * TableGameWatcher is an Observer Design Pattern to notify the computer engine
     * if it is its move or not
     * this is where the chess engine makes its move
     */
    ...
    //update the game board with the new board state
    public void updateGameBoard(final Board board){
        this.chessBoard = board;
    }

    //get the moveLog of the Table
    private MoveLog getMoveLog(){
        return this.moveLog;
    }

    //get the gameHistoryPanel of the Table
    private GameHistoryPanel getGameHistoryPanel(){
        return this.gameHistoryPanel;
    }

    //get the boardPanel of the Table
    private BoardPanel getBoardPanel(){
        return this.boardPanel;
    }

    //To notify the observer which in our case is the TableGameWatcher
    private void moveMadeUpdate(final PlayerType playerType){
        setChanged();
        notifyObservers(playerType);
    }

    //AIThinkTank extends SwingWorker to perform lengthy GUI interaction task in the background
